...
Scope { // Scope
    ...
    Variants { // For each monitor
        ...
        PanelWindow { // Window
            ...
            id: dockRoot
            screen: modelData
            visible: modelData.name !== "DP-3" && !GlobalStates.screenLocked
            ...
            implicitHeight: (70) + Appearance.sizes.elevationMargin + Appearance.sizes.hyprlandGapsOut
            ...
            MouseArea {
                ...
                anchors {
                    ...
                    topMargin: dockRoot.reveal ? 0 : 
                        false ? (dockRoot.implicitHeight - 70) :
